...
st.info("ℹ️ Note: Accuracy may decrease after tuning because some settings make the model simpler or more strict. Default values can sometimes perform better.")
